...
function MailSmtp($reciever, $subject, $content, $headers, $debug = 0) {
  ...
  $smtp_server = 'smtp.jino.ru'; // адрес SMTP-сервера
  $smtp_port = 587; // порт SMTP-сервера
  $smtp_user = '1@object-plant.ru'; // Имя пользователя для авторизации на SMTP-сервере
  $smtp_password = '8EpGL2k31BNg4viU'; // Пароль для авторизации на SMTP-сервере
  $mail_from = '1@object-plant.ru'; // Ящик, с которого отправляется письмо
