...
$('a[data-src="#popup-form"]').click(function(e){
	var target = $(e.currentTarget).attr('data-target');
	$('#popup-form').attr('data-target', target);
});
...
$("#answer-form").submit(function(){
  $.ajax({
    ...
    data: $(this).serialize()
  	...
  	ym(61162486,'reachGoal', 'any_question');
    $(this).find("input").val("");
    $.fancybox.open({
      src: '#fancyalert',
    });
...
$("#popup-form").submit(function(){
  $.ajax({
    ...
    data: $(this).serialize()
  	...
  	ym(61162486,'reachGoal', $('#popup-form').attr('data-target'));
    $(this).find("input").val("");
